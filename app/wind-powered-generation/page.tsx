						...
						<div className="space-y-8">
							<div className="space-y-6">
								...
								<p className="text-lg text-muted-foreground leading-relaxed">
									The concept is to use the natural wind resource at an industrial facility to
									generate power for consumption on-site.
								</p>
							</div>
							...
							<div className="space-y-6">
								...
								<p className="text-muted-foreground leading-relaxed">
									Inducode can offer a complete turnkey solution from the design stage right through
									to commissioning.
								</p>
							</div>
						</div>
			...
			<section className="py-20">
				<div className="container mx-auto px-4">
					<div className="text-center space-y-8 max-w-3xl mx-auto">
						...
						<p className="text-lg text-muted-foreground leading-relaxed">
							Contact our wind energy experts to discuss your on-site wind power generation requirements
							and discover how WPG can reduce your energy costs.
						</p>
