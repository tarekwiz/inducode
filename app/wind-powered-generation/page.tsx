  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              In the current climate of rising energy prices and uncertain fossil fuel price stability, and with the
              increasing impact of 'carbon taxes' or carbon trading schemes on-site WPG provides an attractive and
              economic alternative to imported grid electricity.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">The Concept</h2>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  The concept is to use the natural wind resource at an industrial facility to generate power for
                  consumption on-site.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Inducode can offer a complete turnkey solution from the design stage right through to commissioning.
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide text-sm">Design & Install</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Complete design, installation, operation and maintenance of on-site WPG systems
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide text-sm">Power Range</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide text-sm">Height Range</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Turbine heights ranging from 40 – 80 meters for optimal wind capture
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide text-sm">Full Service</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-muted-foreground text-sm leading-relaxed">
      ...
      <section className="py-20 bg-muted border-t-2 border-b-2 border-border">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">Contract Options</h2>
            <div className="w-24 h-1 bg-accent mx-auto"></div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 border-border bg-card p-6">
              <CardContent className="text-center space-y-4 p-0">
                <h3 className="text-xl font-bold text-accent uppercase tracking-wide">EPC</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Engineering, Procurement, and Construction contracts for complete project delivery
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-border bg-card p-6">
              <CardContent className="text-center space-y-4 p-0">
                <h3 className="text-xl font-bold text-accent uppercase tracking-wide">BOT</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Build, Operate, Transfer agreements for long-term energy solutions
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-border bg-card p-6">
              <CardContent className="text-center space-y-4 p-0">
                <h3 className="text-xl font-bold text-accent uppercase tracking-wide">PPA</h3>
                <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">Ready to Harness Wind Power?</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Contact our wind energy experts to discuss your on-site wind power generation requirements and discover
              how WPG can reduce your energy costs.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-sm opacity-80 leading-relaxed">
                Leading provider of sustainable wind energy solutions for industrial facilities.
              </p>
            </div>

            <div className="space-y-4">
              <h4 className="font-bold uppercase tracking-wide">Contact Info</h4>
            ...
            <div className="space-y-4">
              <h4 className="font-bold uppercase tracking-wide">Quick Links</h4>
