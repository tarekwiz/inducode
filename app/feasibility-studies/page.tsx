          ...
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                Comprehensive energy feasibility studies that provide accurate
                real-life analysis covering all aspects of your energy
                requirements and business case development.
              </p>
            </div>
          </div>
        </div>
              ...
              <Card className="border-2 border-border bg-card p-8">
                <CardContent className="p-0 space-y-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Inducode Technologies LLC experts are involved in the
                    design, build, operation and maintenance of Turn Key
                    solutions. Inducode Technologies LLC provide accurate real
                    life feasibility studies which cover all aspects of your
                    energy requirements. Our Energy Feasibility Studies are an
                    important business case analysis tool which we use in
                    preparation for helping you make effective business
                    decisions on your energy needs.
                  </p>

                  <p className="text-muted-foreground leading-relaxed">
                    A feasibility study can determine which combination of
                    renewable energy technologies most effectively meet your
                    energy requirements and goals. When integrating renewable
                    energy into a new construction project or major renovation,
                    this level of renewable energy assessment will typically be
                    commissioned by our design team.
                  </p>

                  <p className="text-muted-foreground leading-relaxed">
                    Screenings look at the viability of each type of renewable
                    energy, a feasibility study gets into details used to choose
                    technologies and options within a technology type, such as
                    the scale of wind turbine or the type of solar thermal
              ...
              <Card className="border-2 border-border bg-card p-8">
                <CardContent className="p-0 space-y-6">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    The feasibility study takes a deeper look into the remaining
                    technologies to:
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-4">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Quantify energy variations, and the value of that
                        energy.
                      </p>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Review details of utility interconnection, tariffs, and
                        revenue.
                      </p>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Analyse access to financial incentives as well as
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Assess economic feasibility with a detailed and credible
                  ...
                  <div className="border-t-2 border-border pt-6 mt-8">
                    <p className="text-muted-foreground leading-relaxed">
                      Renewable energy feasibility studies provide technology
                      and financing options. We at Inducode Technologies LLC
                      carry out comprehensive feasibility studies for all our
                      clients as part of our overall solution.
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed text-sm">
                  Comprehensive evaluation of current energy systems and
                  requirements
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Contact our team of experts to discuss your feasibility study
              requirements and learn how we can help optimize your energy
              systems.
            </p>
