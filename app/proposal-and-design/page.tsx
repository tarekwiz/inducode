          ...
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                Leading provider of on-site energy solutions with proven expertise in design, build, and management of
                sustainable energy systems since 1998.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-muted-foreground leading-relaxed">
                <p>
                  Inducode Technologies LLC is a leading provider of on-site energy solutions with a proven track record
                  in the successful design, build and management of CHP, Tri-generation, district heating and cooling
                  solutions.
                </p>
                <p>
                  Since 1998 we have developed core competencies in energy efficiency related projects. We understand
                  the demands of business having been energy solutions owners and operators of solutions ourselves.
                </p>
                <p>
                  Both owning and operating energy efficient solutions has allowed us to offer customers an engineering
                  excellence combined with a high degree of financial stability.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Card className="border-2 border-border bg-card p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground uppercase tracking-wide">Expert Engineers</p>
              </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              We have an in-house team of qualified and experienced engineers, ensuring consistently high quality work.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  Combined Heat and Power system design, implementation, and optimization for maximum energy efficiency.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  Advanced tri-generation systems providing electricity, heating, and cooling from a single fuel source.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  District heating and cooling solutions for high-density developments and commercial complexes.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide">Project Management</CardTitle>
              </CardHeader>
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  End-to-end project management ensuring on-time delivery and budget compliance for all projects.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  Comprehensive operation and maintenance services to ensure optimal system performance and longevity.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide">Financial Stability</CardTitle>
              </CardHeader>
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  High degree of financial stability backed by our experience as energy solution owners and operators.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-muted border-t-2 border-b-2 border-border">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              We are dedicated to providing low energy on-site solutions and can support projects from concept design
              through to delivery, operation and maintenance of systems.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <Card className="border-2 border-border bg-card p-6">
                ...
                <CardContent className="px-0 pb-0">
                  <p className="text-muted-foreground leading-relaxed">
                    Our clients gain the benefit of a single point of contact and a single line of responsibility
              ...
              <Card className="border-2 border-border bg-card p-6">
                ...
                <CardContent className="px-0 pb-0">
                  <p className="text-muted-foreground leading-relaxed">
                    Combined with our engineering excellence, we ensure the most cost effective, energy efficient and
                    maintainable solution is achieved.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-border bg-card p-6">
                ...
                <CardContent className="px-0 pb-0">
                  <p className="text-muted-foreground leading-relaxed">
                    In conjunction with our customers, we work with leading consultants, architects, developers &
            ...
            <div className="space-y-6">
              <div className="text-center p-8 border-2 border-accent bg-accent/5">
                <h3 className="text-2xl font-bold text-accent mb-4 uppercase tracking-wide">Full Service Lifecycle</h3>
          ...
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Contact our team of experts to learn how we can help optimize your energy systems and deliver
