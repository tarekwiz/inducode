        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              Our project managers possess the technical capabilities and people skills needed to effectively manage
              projects on all levels, ensuring successful completion and stakeholder satisfaction.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Our team combines proven field experience with exceptional people skills to deliver projects successfully
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Our project managers have demonstrated technical capabilities in bringing projects to successful
                    conclusions, enabling accurate workload assessment and timeline management.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Technical knowledge combined with strong interpersonal abilities results in effective resource
                    allocation and comprehensive project management throughout the entire process.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    We engage customers to fully understand project requirements and assess the overall impact to their
                    business, ensuring alignment with strategic objectives.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Inducode Technologies LLC delivers end-to-end project management solutions that ensure successful project
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide">Project Leadership</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent"></div>
                    <span className="text-sm text-muted-foreground">Overall Project Responsibility</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent"></div>
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent"></div>
                    <span className="text-sm text-muted-foreground">Project Team Building & Mentoring</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide">Schedule Management</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent"></div>
                    <span className="text-sm text-muted-foreground">Detailed Schedule Development</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent"></div>
                    <span className="text-sm text-muted-foreground">Milestone Tracking & Achievement</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent"></div>
                    <span className="text-sm text-muted-foreground">Resource Loading & Adjustment</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent"></div>
                    <span className="text-sm text-muted-foreground">Proactive Problem Identification</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent"></div>
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-accent"></div>
                    <span className="text-sm text-muted-foreground">Risk Mitigation Strategies</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide">Progress Monitoring</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
      ...
      <section className="py-20 bg-muted border-t-2 border-b-2 border-border">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Successful project management starts with detailed planning and an understanding of customer needs.
            </p>
          </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                          We engage customers to fully understand their project requirements and assess the overall
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                          Comprehensive project planning ensures all aspects are considered, from scope definition to
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                          Our proven field experience enables accurate assessment of workload and time requirements for
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                          Regular updates to key stakeholders and continuous performance monitoring ensure project
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Let our experienced project management team guide your next engineering project to successful completion.
