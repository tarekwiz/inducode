...
import { ArrowRight, Cog, Leaf, Users, Mail, Phone, MapPin, Zap, Shield, Settings } from "lucide-react"
          ...
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
                Leading provider of innovative engineering solutions for sustainable energy systems, process
                optimization, and industrial technologies.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Discover our cutting-edge technologies that deliver sustainable, efficient, and reliable energy solutions
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <div className="relative h-64 overflow-hidden border-b-2 border-border">
                <img
                  src="/combined-heat-and-power-system-diagram-with-effici.png"
                  alt="Combined Heat And Power (CHP)"
                  className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
                />
                <div className="absolute top-4 right-4">
                  <div className="w-12 h-12 bg-accent border-2 border-accent flex items-center justify-center">
                    <div className="w-6 h-6 bg-accent-foreground opacity-90"></div>
                  </div>
                </div>
              </div>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Combined heat and Power (CHP) is the simultaneous on-site generation of usable heat and electricity
                  from a single fuel source, delivering exceptional energy efficiency.
                </p>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <div className="relative h-64 overflow-hidden border-b-2 border-border">
                <img
                  src="/abstract-geometric-shapes.png?height=256&width=400&query=tri-generation energy system"
                  alt="TRI-GENERATION"
                  className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
                />
                <div className="absolute top-4 right-4">
                  <div className="w-12 h-12 bg-secondary border-2 border-secondary flex items-center justify-center">
                    <div className="w-6 h-6 bg-secondary-foreground opacity-90"></div>
                  </div>
                </div>
              </div>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Tri-generation is the generation of three energy outputs (electricity, heat, and chilled water) from
                  one single fuel input, maximizing energy utilization.
                </p>
                <div className="space-y-2 mb-6">
                  <div className="flex items-center text-sm">
                    <div className="w-2 h-2 bg-accent mr-3"></div>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <div className="relative h-64 overflow-hidden border-b-2 border-border">
                <img
                  src="/abstract-geometric-shapes.png?height=256&width=400&query=district heating cooling system"
                  alt="DISTRICT HEATING & COOLING"
                  className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
                />
                <div className="absolute top-4 right-4">
                  <div className="w-12 h-12 bg-chart-3 border-2 border-chart-3 flex items-center justify-center">
                    <div className="w-6 h-6 bg-white opacity-90"></div>
                  </div>
                </div>
              </div>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  A District Cooling/Heating system distributes energy in the form of chilled water, hot water or steam
                  from a central source to high density developments.
                </p>
                <div className="space-y-2 mb-6">
                  <div className="flex items-center text-sm">
                    <div className="w-2 h-2 bg-accent mr-3"></div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Designing HVAC and HVAC-R engineering using industry-leading software and best practices. Modeling of
                  processes and Using Spread Sheet Based Engineering calculations, Commissioning and Start-up of systems
                  and equipment.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We provide engineering services such as feasibility studies, energy audits, design engineering,
                  project management, procurement, construction management, commissioning, start-up, and training.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Thermal Process Engineering projects, design and analysis of heat exchangers, improved oil recovery,
                  carbon sequestration, improved oil recovery, production optimization, optimization and improvement of
      ...
      <section className="py-16 bg-muted border-t-2 border-b-2 border-border">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">Fire Fighting Systems</h2>
            ...
            {[
              ...
              >
                <CardContent className="p-0">
                  <div className="aspect-square overflow-hidden bg-muted border-b-2 border-border relative">
                    <img
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div className="space-y-4">
                <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">Get In Touch</h2>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Ready to discuss your next project? Contact our team of experts to learn how we can help optimize your
                  energy systems and engineering challenges.
                </p>
              </div>
            ...
            <Card className="p-8 border-2 border-border bg-card">
              ...
              <CardContent className="px-0 pb-0">
                <form className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-foreground uppercase tracking-wide">Company Name</label>
                    <input
                      type="text"
                      className="w-full px-3 py-2 border-2 border-border bg-input focus:outline-none focus:border-accent text-foreground"
