        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              We deliver conventional power generation solutions up to 150MWe using our extensive experience in
              combining power generation technologies with advanced cooling and heat generation systems.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  We use our experience in combining power generation from turbines, medium speed engines and high speed
                  engines with our extensive knowledge of conventional cooling and heat generation technologies.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Our preliminary engineering assessment looks at enhancing conventional power generation with
                  renewables while also ensuring the latest technologies are introduced to ensure optimum efficiency.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Our team are continually looking at the lifecycle aspect of the projects while implementing the
                  highest standard of engineering.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <Card className="border-2 border-border bg-card">
                <CardHeader className="pb-4">
                  ...
                  <CardTitle className="text-accent uppercase tracking-wide">Power Generation Range</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    Solutions up to 150MWe capacity using turbines, medium speed engines, and high speed engines.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-border bg-card">
                <CardHeader className="pb-4">
                  ...
                  <CardTitle className="text-secondary uppercase tracking-wide">Integrated Systems</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    Combining power generation with conventional cooling and heat generation technologies for maximum
                    efficiency.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-border bg-card">
                <CardHeader className="pb-4">
                  ...
                  <CardTitle className="text-chart-3 uppercase tracking-wide">Engineering Excellence</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    Highest standard of engineering with lifecycle considerations and renewable energy integration.
                  </p>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Contact our team of experts to learn how we can deliver efficient conventional power generation solutions
