        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              Ready to discuss your energy solutions? Our team of experts is here to help you optimize your systems and
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <Card className="border-2 border-border bg-card p-8">
              <CardContent className="p-0 space-y-6">
                <div className="space-y-4">
                  <h2 className="text-2xl font-bold text-foreground uppercase tracking-wide">Send Us A Message</h2>
                ...
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input className="border-2 border-border bg-background" placeholder="Enter your first name" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-foreground uppercase tracking-wide">Last Name</label>
                      <Input className="border-2 border-border bg-background" placeholder="Enter your last name" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-foreground uppercase tracking-wide">Company</label>
                    <Input className="border-2 border-border bg-background" placeholder="Enter your company name" />
                  </div>

                  <div className="space-y-2">
                    <label className="text-sm font-bold text-foreground uppercase tracking-wide">Subject</label>
                    <Input className="border-2 border-border bg-background" placeholder="What can we help you with?" />
                  </div>
            ...
            <div className="space-y-8">
              <Card className="border-2 border-border bg-card p-8">
                <CardContent className="p-0 space-y-6">
                  <h2 className="text-2xl font-bold text-foreground uppercase tracking-wide">Contact Information</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-foreground uppercase tracking-wide">Address</h3>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-foreground uppercase tracking-wide">Business Hours</h3>
              ...
              <Card className="border-2 border-border bg-card p-8">
                <CardContent className="p-0 space-y-4">
                  <h3 className="text-xl font-bold text-foreground uppercase tracking-wide">Why Choose Inducode?</h3>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">Ready to Start Your Project?</h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Our team is standing by to help you achieve your energy efficiency goals. Contact us today for a
              consultation.
            </p>
