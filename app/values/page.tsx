        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              The fundamental principles that guide our operations, decisions, and relationships with clients and
              colleagues.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card p-0">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  results. We have a clear vision of where we are going. We focus our resources to achieve leadership
                  objectives and strategies. We develop the capability to deliver our strategies and eliminate
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card p-0">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We have a compelling desire to improve and to win in the marketplace, we are determined to be the best
                  at doing what we do, and we have a healthy dissatisfaction with the status quo.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card p-0">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We respect our colleagues, customers, consumers, and treat them as we want to be treated. We have
                  confidence in each other's capabilities and intentions. We believe that people work best when there is
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Experience our values in action. Contact us to discuss how we can help with your next project.
            </p>
