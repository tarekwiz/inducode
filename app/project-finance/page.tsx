        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              Flexible finance solutions to deliver energy savings for your business through ESCo and BOO models.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <Card className="border-2 border-border bg-card">
              ...
              <CardContent className="space-y-6">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Inducode Technologies LLC can offer you a number of flexible finance solutions to deliver energy
                  saving for your business. Having first identified and verified that an on-site energy generation
                  solution is a viable option we work with our customers to understand their requirements and then offer
                  a tailored financial solution whereby we take on the financing of the project.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Projects delivered in this way are often referred to as ESCo (Energy Supply Company) or BOO (Build Own
                  Operate) models. We can guarantee seamless migrations from your existing energy arrangements to high
                  ...
                  <div className="grid gap-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                          Inducode Technologies LLC acts as an Energy Supply Company (ESCo) your energy supplier.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                          Customer enters into Power Purchase Agreement (PPA) with Inducode Technologies LLC with agreed
                          rates for energy.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-foreground uppercase tracking-wide mb-2">Single Monthly Bill</h3>
                        <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="border-2 border-border bg-card">
              ...
              <CardContent>
                <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                  Inducode Technologies LLC designs, builds, operates, maintains and finances an on-site energy
                  solution, which delivers the primary energies needs of your business (electricity, hot water/steam and
                  cooling). Inducode Technologies LLC can provide the turnkey energy centre and take over the full
                  procurement of all energy requirements.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
