  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              The generation of three energy outputs (electricity, heat, and chilled water) from one single fuel input,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">What is Tri-Generation?</h2>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Tri-generation is the generation of three energy outputs (namely Electricity, Heat, and Chilled Water)
                  from one single fuel input. Typically, natural gas or diesel can be used as fuel in an on-site
                  Combined Cooling, Heat and Power plant.
                </p>
              </div>
            </div>
            <div className="bg-card border-2 border-border p-8">
              <div className="text-center space-y-6">
                ...
                <h3 className="text-2xl font-bold text-foreground uppercase tracking-wide">Single Fuel Input</h3>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">System Components</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              A Tri-Generation plant typically consists of three primary components working together to maximize energy
              efficiency.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 border-border hover:border-accent transition-all duration-300 bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide">CHP Generation Plant</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-muted-foreground leading-relaxed">
                  For the purposes of converting the fuel input to usable electricity and heat through efficient
            ...
            <Card className="border-2 border-border hover:border-accent transition-all duration-300 bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide">Absorption Chiller</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-muted-foreground leading-relaxed">
                  For the purposes of converting some of the CHP heat output to usable chilled water using thermal
            ...
            <Card className="border-2 border-border hover:border-accent transition-all duration-300 bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide">Controls & Distribution</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-muted-foreground leading-relaxed">
                  For the purposes of delivering the above energies to the Client's premises with intelligent monitoring
                  and control systems.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-muted border-t-2 border-b-2 border-border">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              An 'Absorption Chiller' is a device that uses heat instead of mechanical energy to provide cooling. It
              does this via a thermal compressor, which consists of an absorber, a generator, a pump, and a throttling
              device. The thermal compressor of an absorption chiller replaces the mechanical vapour compressor used in
              electrical chillers.
            </p>
            <div className="bg-card border-2 border-border p-8">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">Benefits of Tri-Generation</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Tri-Generation technology offers significant advantages in energy efficiency, cost reduction, and
      ...
      <section className="py-20 bg-muted border-t-2 border-border">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Contact our experts to learn how Tri-Generation technology can optimize your energy systems and reduce
              operational costs.
            </p>
