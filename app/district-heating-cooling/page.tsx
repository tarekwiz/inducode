					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div className="space-y-6">
							...
							<p className="text-lg text-muted-foreground leading-relaxed">
								The central source (energy centre) allows for the incorporation of high efficiency
								generation from fossil fuel and renewable sources. The thermal energy is provided from a
								central plant which eliminates the need for separate cooling/heating systems in
								individual buildings, homes and businesses.
							</p>
							<p className="text-lg text-muted-foreground leading-relaxed">
								Heat exchangers are used at the point of consumption to transfer the energy at the
								required temperature often referred to as Heat Interface Unit (HIU). District energy
								networks have been used for many years throughout the world and in some European cities
								provide up to 80% of a city's heat requirement.
							</p>
						</div>
						...
						{[
							{
								...
								description: 'Centralized systems achieve higher efficiency rates',
							},
							{ title: 'Reduced Costs', description: 'Lower operational and maintenance costs per unit' },
							{
								title: 'Constant and Reliable',
								description: 'Consistent energy supply with backup systems',
							},
							{
							...
							},
							{
								...
								description: 'Reduced carbon footprint through efficient generation',
							},
							...
							{ title: 'Continuous Supply', description: '24/7 chilled/hot water availability' },
							{
								...
								description: 'Increased reliability through centralized monitoring',
							},
							{ title: 'Low Maintenance', description: 'Reduced maintenance requirements for end users' },
						].map((benefit, index) => (
							<Card
								key={index}
								className="border-2 border-border hover:border-accent transition-colors bg-card"
							>
				...
				<div className="container mx-auto px-4">
					...
					<div className="max-w-4xl mx-auto space-y-8">
						<p className="text-lg text-muted-foreground leading-relaxed text-center">
							With the integration of the latest technology District Energy Systems from PEWO our German
							partner we deliver the most reliable and efficient energy solutions. PEWO's manufacturing
							and district energy experience combined with Inducode's engineering excellence delivers the
							...
							<Card className="border-2 border-border bg-card">
								...
								<CardContent className="space-y-3">
									<div className="flex items-center text-sm">
										...
										<span>
											Experience in CHP, Tri-generation, boilers and chiller, steam, biomass and
											renewable
										</span>
									</div>
									<div className="flex items-center text-sm">
			...
			<section className="py-20">
				<div className="container mx-auto px-4">
					<div className="text-center space-y-8 max-w-3xl mx-auto">
						...
						<p className="text-lg text-muted-foreground leading-relaxed">
							Contact our team to discuss how district heating and cooling systems can benefit your
							development project.
						</p>
