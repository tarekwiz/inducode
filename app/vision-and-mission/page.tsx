            ...
            <Card className="border-2 border-border bg-card p-0">
              ...
              <CardContent className="p-8">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Our Vision is to be a <span className="text-accent font-semibold">global leader</span> creating
                  maximum value in the successful delivery of sustainable technologies, solutions and energy efficient
              ...
              <CardContent className="p-8 space-y-6">
                <div className="space-y-4">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    <span className="text-accent font-semibold">turnkey energy solution</span> under an engineer,
                    procure and construct (EPC) type contract or via a Power Purchase Agreement whereby Inducode
                    Technologies LLC funds the commissioning cost of the project by selling the electricity, heating,
                    cooling and steam outputs back to the customer.
                  </p>

                  <p className="text-lg text-muted-foreground leading-relaxed">
                    To develop and supply{" "}
                    <span className="text-accent font-semibold">
                      machinery, robotics, industrial automation products & building management systems
                    </span>
                    , which are intended for innovative & UN-paralleled control, visualization, productivity and
                    connectivity. Such systems will be used for flexible production of small to medium-large business.
                  </p>

                  <p className="text-lg text-muted-foreground leading-relaxed">
                    To supply{" "}
                    <span className="text-accent font-semibold">energy efficient products, construction materials</span>{" "}
                    to achieve the best comfort, safest environment. Our products, solutions & services will provide
                    substantial financial savings to our customers.
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground uppercase tracking-wide">Our Core Values</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 border-border bg-card text-center p-6">
              <CardContent className="space-y-4">
                ...
                <h3 className="text-xl font-bold text-foreground uppercase tracking-wide">Sustainability</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Committed to delivering environmentally responsible solutions that reduce carbon footprint and promote
            ...
            <Card className="border-2 border-border bg-card text-center p-6">
              <CardContent className="space-y-4">
                ...
                <h3 className="text-xl font-bold text-foreground uppercase tracking-wide">Innovation</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Continuously advancing technology and engineering solutions to meet evolving industry challenges and
                  customer needs.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-border bg-card text-center p-6">
              <CardContent className="space-y-4">
                ...
                <h3 className="text-xl font-bold text-foreground uppercase tracking-wide">Excellence</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Maintaining the highest standards in project delivery, customer service, and technical expertise
      ...
      <section className="py-20 bg-muted border-t-2 border-border">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">Ready to Work With Us?</h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Let's discuss how our vision and mission align with your energy and industrial automation needs.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              ...
              <div className="flex items-center justify-center space-x-3">
                ...
                <div className="text-left">
                  <p className="font-bold text-foreground uppercase tracking-wide text-sm">Location</p>
