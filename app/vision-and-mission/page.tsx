        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              Driving the future of sustainable energy technologies and
            ...
            <Card className="border-2 border-border bg-card p-0">
              ...
              <CardContent className="p-8">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  creating maximum value in the successful delivery of
                  sustainable technologies, solutions and energy efficient
              ...
              <CardContent className="p-8 space-y-6">
                <div className="space-y-4">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    under an engineer, procure and construct (EPC) type contract
                    or via a Power Purchase Agreement whereby Inducode
                    Technologies LLC funds the commissioning cost of the project
                    by selling the electricity, heating, cooling and steam
                    outputs back to the customer.
                  </p>

                  <p className="text-lg text-muted-foreground leading-relaxed">
                    To develop and supply{" "}
                    <span className="text-accent font-semibold">
                      machinery, robotics, industrial automation products &
                      building management systems
                    </span>
                    , which are intended for innovative & UN-paralleled control,
                    visualization, productivity and connectivity. Such systems
                    will be used for flexible production of small to
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    to achieve the best comfort, safest environment. Our
                    products, solutions & services will provide substantial
                    financial savings to our customers.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 border-border bg-card text-center p-6">
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Committed to delivering environmentally responsible solutions
                  that reduce carbon footprint and promote sustainable energy
                  practices.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-border bg-card text-center p-6">
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Continuously advancing technology and engineering solutions to
                  meet evolving industry challenges and customer needs.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-border bg-card text-center p-6">
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Maintaining the highest standards in project delivery,
                  customer service, and technical expertise across all
                  operations.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Let's discuss how our vision and mission align with your energy
