          ...
          <Card className="border-2 border-border bg-card">
            ...
            <CardContent className="text-center">
              <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                Our Culture is one of entrepreneurship implemented with fairness
                and sustainability. Our Team is committed to our client
          ...
          <Card className="border-2 border-border bg-card">
            ...
            <CardContent className="text-center">
              <p className="text-xl text-muted-foreground leading-relaxed max-w-4xl mx-auto">
                Our Strategy is to deliver meaningful financial saving to our
                clients through the efficient on-site generation of electricity,
                chilled water and steam/hot water from renewable and fossil fuel
                sources. This is achieved through the Inducode direct sales
                force, our extensive customer network, qualified local partners,
                industry and professional organization, and suppliers.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Contact us to learn more about our culture and strategic approach
              to energy solutions.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-accent border-2 border-accent flex items-center justify-center"></div>
              </div>
