    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <Card className="border-2 border-border bg-card">
            <CardHeader className="text-center pb-6">
              <CardTitle className="text-3xl font-bold text-foreground uppercase tracking-wide">CULTURE</CardTitle>
              <div className="w-16 h-1 bg-accent mx-auto mt-4"></div>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                Our Culture is one of entrepreneurship implemented with fairness and sustainability. Our Team is
                committed to our client company's vision and culture.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <Card className="border-2 border-border bg-card">
            <CardHeader className="text-center pb-6">
              <CardTitle className="text-3xl font-bold text-foreground uppercase tracking-wide">STRATEGY</CardTitle>
              <div className="w-16 h-1 bg-accent mx-auto mt-4"></div>
            </CardHeader>
            <CardContent className="text-center">
              <p className="text-xl text-muted-foreground leading-relaxed max-w-4xl mx-auto">
                Our Strategy is to deliver meaningful financial saving to our clients through the efficient on-site
                generation of electricity, chilled water and steam/hot water from renewable and fossil fuel sources.
                This is achieved through the Inducode direct sales force, our extensive customer network, qualified
                local partners, industry and professional organization, and suppliers.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="py-20 bg-muted border-t-2 border-border">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8">
            <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">Ready to Work Together?</h2>
