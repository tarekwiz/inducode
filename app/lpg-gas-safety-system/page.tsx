					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div className="space-y-6">
							...
							<p className="text-lg text-muted-foreground leading-relaxed">
								Liquefied Petroleum Gas (LPG) is a clean and safe fuel that has a range of properties
								closest to petrol. It is a by-product of petrol refining and natural gas production.
								Under slight pressure, LPG turns into liquid form and can then be stored in tanks. LPG
								is converted back to gas before being burned in the engine.
							</p>
							<p className="text-lg text-muted-foreground leading-relaxed">
								In every LPG or GAS plant our experience lives in innovations and ongoing challenges
								that thrust us every day towards the future. We are in for a constant evolution, in line
								with our customers' highest expectations, in terms of quality and competitiveness.
							</p>
						</div>
				...
				<div className="container mx-auto px-4">
					<div className="text-center space-y-4 mb-16">
						...
						<p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
							We are the leader group in creating technologically advanced products and services for
							natural gas distribution and use, targeting our research on the coverage of all needs.
						</p>
					</div>
				...
				<div className="container mx-auto px-4">
					<div className="text-center space-y-4 mb-16">
						...
						<p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
							No matter how extreme or demanding the conditions, your people and facilities come first.
							That's why Inducode Technologies LLC is dedicated to offering the most comprehensive and
							advanced detection technologies available.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						<Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
							...
							<CardContent className="text-center">
								<p className="text-muted-foreground leading-relaxed">
									Comprehensive gas detection and safety systems designed to excel under the toughest
									conditions
								</p>
							</CardContent>
						</Card>
						...
						<Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
							...
							<CardContent className="text-center">
								<p className="text-muted-foreground leading-relaxed">
									Advanced gas leak detection systems to identify and alert of potential hazards
									immediately
								</p>
							</CardContent>
						</Card>
						...
						<Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
							...
							<CardContent className="text-center">
								<p className="text-muted-foreground leading-relaxed">
									Ultra sonic leak detection technology for precise monitoring and early warning
									systems
								</p>
							</CardContent>
						</Card>
				...
				<div className="container mx-auto px-4">
					<div className="text-center space-y-8 max-w-3xl mx-auto">
						...
						<p className="text-xl text-muted-foreground leading-relaxed">
							Contact our experts to discuss your LPG plant design and gas safety system requirements.
							We're here to help keep your people safe and operations running smoothly.
						</p>
