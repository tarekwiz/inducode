        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              ...
              building services, as its aim is to protect human life and
              property, strictly in that order.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              It consists of three basic parts that work together to provide
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  A large store of water in tanks, either underground or on top
                  of the building, called fire storage tanks
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  A specialized pumping system designed to deliver water at the
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Comprehensive fire protection systems and equipment for complete
              safety coverage
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Contact our fire safety experts to discuss your fire protection
              requirements and ensure comprehensive safety coverage for your
              facility.
            </p>
