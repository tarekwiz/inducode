      ...
      <header className="border-b-2 border-border bg-card sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            ...
            <Link
              href="/"
              className="flex items-center text-muted-foreground hover:text-accent transition-colors font-medium uppercase tracking-wide text-sm"
            >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              A firefighting system is probably the most important of the building services, as its aim is to protect
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide">Fire Storage Tanks</CardTitle>
              </CardHeader>
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  A large store of water in tanks, either underground or on top of the building, called fire storage
                  tanks
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  A specialized pumping system designed to deliver water at the required pressure and flow rate
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide">Distribution Network</CardTitle>
              </CardHeader>
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  A large network of pipes ending in either hydrants or sprinklers (nearly all buildings require both of
                  these systems)
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card p-0">
              ...
              <CardContent className="p-6">
                <h3 className="font-bold text-center text-lg text-foreground uppercase tracking-wide mb-2">FOAM</h3>
                <p className="text-muted-foreground text-sm text-center leading-relaxed">
      ...
      <section className="py-20 bg-muted border-t-2 border-border">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground uppercase tracking-wide">Fire Safety Consultation</h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Contact our fire safety experts to discuss your fire protection requirements and ensure comprehensive
              safety coverage for your facility.
            </p>
