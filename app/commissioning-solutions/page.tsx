        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              Ensuring maximum efficiency and optimal performance of your designed and implemented systems through
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Commissioning is a very important stage to ensure the efficiency of designed and implemented systems.
                  Despite the designed smart solutions and the high quality construction work, the plant will not get
                  the maximum output results (or even failure in operation sometimes) if the plant was not commissioned
                  well.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground uppercase tracking-wide">Maximum Efficiency</h3>
                    <p className="text-muted-foreground">Ensure systems operate at peak performance levels</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground uppercase tracking-wide">Prevent Failures</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground uppercase tracking-wide">Verify Performance</h3>
                    <p className="text-muted-foreground">Test and confirm systems meet design specifications</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card border-2 border-border p-8">
              <div className="text-center space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Commissioning is a series of activities to test and verify the readiness of integrated systems to
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Inducode Technologies LLC provides comprehensive commissioning services across mechanical and electrical
              systems.
            </p>
          </div>
              ...
              <CardContent className="p-8">
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-foreground uppercase tracking-wide mb-2">Hydro-Testing</h3>
                      <p className="text-muted-foreground">
                        Pressure testing of piping systems and vessels to ensure structural integrity and leak
                        detection.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        System cleaning and chemical treatment to remove contaminants and prepare systems for operation.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-4 h-4 bg-accent mt-2"></div>
                    <div>
                      <h3 className="font-bold text-foreground uppercase tracking-wide mb-2">Balancing</h3>
                      <p className="text-muted-foreground">
                        Flow and pressure balancing to ensure optimal system performance and energy efficiency.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Insulation resistance testing to verify electrical safety and system integrity.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-4 h-4 bg-accent mt-2"></div>
                    <div>
                      <h3 className="font-bold text-foreground uppercase tracking-wide mb-2">Resistance Insulation</h3>
                      <p className="text-muted-foreground">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        High voltage testing to verify insulation strength and electrical safety.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-4 h-4 bg-accent mt-2"></div>
                    <div>
                      <h3 className="font-bold text-foreground uppercase tracking-wide mb-2">Coordination Study</h3>
                      <p className="text-muted-foreground">
                        Protection coordination analysis to ensure proper system operation and safety.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-4 h-4 bg-accent mt-2"></div>
                    <div>
                      <h3 className="font-bold text-foreground uppercase tracking-wide mb-2">PLC Pre-commissioning</h3>
                      <p className="text-muted-foreground">
                        Programmable Logic Controller testing and verification before system startup.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Precision calibration of measurement and control instruments for accurate operation.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Contact our commissioning experts to ensure your systems operate at maximum efficiency from day one.
              </p>
            </div>
