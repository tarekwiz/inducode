				...
				<div className="container mx-auto px-4">
					<div className="text-center space-y-8 max-w-4xl mx-auto">
						...
						<p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
							The core principles that guide our operations and define our commitment to excellence in
				...
				<div className="container mx-auto px-4">
					<div className="text-center space-y-8 max-w-3xl mx-auto">
						...
						<p className="text-xl text-muted-foreground leading-relaxed">
							Experience the difference our operating principles make in delivering exceptional energy
							solutions.
						</p>
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
						<div className="space-y-4">
							...
							<p className="text-sm opacity-80 leading-relaxed">
								Sustainable energy solutions guided by principles of sustainability, innovation, and
								integrity.
							</p>
						</div>
