...
import { ArrowRight, Leaf, Lightbulb, Shield, Mail, Phone, MapPin } from "lucide-react"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              The core principles that guide our operations and define our commitment to excellence in sustainable
              energy solutions.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-accent uppercase tracking-wide text-xl">SUSTAINABILITY</CardTitle>
              </CardHeader>
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed text-lg">
                  Wisely Use of Natural Resources and Maximizing Renewable Energy utilization
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-secondary uppercase tracking-wide text-xl">INNOVATION</CardTitle>
              </CardHeader>
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed text-lg">
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-chart-3 uppercase tracking-wide text-xl">INTEGRITY</CardTitle>
              </CardHeader>
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed text-lg">High business ethics in every aspect</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Experience the difference our operating principles make in delivering exceptional energy solutions.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-sm opacity-80 leading-relaxed">
                Sustainable energy solutions guided by principles of sustainability, innovation, and integrity.
              </p>
            </div>
