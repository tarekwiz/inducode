        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
              Inducode Technologies LLC has the expertise and experience to
              deliver your operations with a comprehensive portfolio of
              future-focused, industry-leading hardware and software designed to
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  Inducode Technologies LLC will help you increase your ROI by
                  investing in our "best-in-class" solutions that are early in
                  their product lifecycles, resulting in solutions for future
                  technologies — today.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  Our Systems and solutions are designed to deliver substantial
                  financial savings because they are designed with productivity
                  in mind.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  Our state-of-the-art products allow you to enhance your
                  flexibility and throughput for increased competitiveness.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  We offer the world's most unique and comprehensive solutions
                  supporting you throughout the complete machine safety
                  life-cycle and exceeding global compliance requirements.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card">
              ...
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  We provide global and local sales and support to ensure you
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Experience the Inducode advantage. Contact our team today to
              discuss how we can deliver competitive solutions for your
              operations.
            </p>
