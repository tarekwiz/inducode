					...
					<div className="grid lg:grid-cols-3 gap-8">
						...
						<Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card p-0">
							...
							<CardContent className="p-6">
								...
								<p className="text-muted-foreground mb-6 leading-relaxed">
									Photovoltaic Solar Systems involve PV cells which capture the sun's energy and
									directly generate electricity using the 'Photo-electric Effect'.
								</p>
						...
						<Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card p-0">
							...
							<CardContent className="p-6">
								...
								<p className="text-muted-foreground mb-6 leading-relaxed">
									Concentrated Solar Power (CSP) technology stores the energy from solar radiation in
									a working fluid in the form of heat. This heat can then be used to run conventional
						...
						<Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card p-0">
							...
							<CardContent className="p-6">
								...
								<p className="text-muted-foreground mb-6 leading-relaxed">
									The Solar Hot Water system is now a mature technology. The benefits of choosing to
									install a solar hot water system are significant when viewed through a long-term
									perspective.
								</p>
								<div className="space-y-2 mb-6">
									<div className="flex items-center text-sm">
			...
			<section className="py-20">
				<div className="container mx-auto px-4">
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
						{['Residential Complexes', 'Hotels', 'Hospitals', 'Industrial Facilities'].map(
							(application, index) => (
								<Card
									key={index}
