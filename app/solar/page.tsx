...
import { ArrowRight, Sun, Zap, Thermometer, Mail, MapPin } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              Comprehensive solar energy solutions from photovoltaic systems to
              concentrated solar power and thermal heating applications.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card p-0">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Photovoltaic Solar Systems involve PV cells which capture the
                  sun's energy and directly generate electricity using the
                ...
                <div className="space-y-2 mb-6">
                  ...
                  <div className="flex items-center text-sm">
                    <div className="w-2 h-2 bg-accent mr-3"></div>
                    <span className="text-muted-foreground">
                      Photo-electric Effect Technology
                    </span>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card p-0">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Concentrated Solar Power (CSP) technology stores the energy
                  from solar radiation in a working fluid in the form of heat.
                  This heat can then be used to run conventional power
                  generation cycles.
                </p>
                <div className="space-y-2 mb-6">
                  <div className="flex items-center text-sm">
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-border hover:border-accent bg-card p-0">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  The Solar Hot Water system is now a mature technology. The
                  benefits of choosing to install a solar hot water system are
                  significant when viewed through a long-term perspective.
                </p>
                <div className="space-y-2 mb-6">
                  <div className="flex items-center text-sm">
                    <div className="w-2 h-2 bg-accent mr-3"></div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-8 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground">
              Ready to harness solar energy for your project? Contact our solar
              experts today.
            </p>
